...
class BaseProvider(object):
    ...
    def _random_elements(self, elements=('a', 'b', 'c'), length=None, unique=False):
    ...
    def random_choices(self, elements=('a', 'b', 'c'), length=None):
        ...
        """
        return self._random_elements(elements, length, unique=False)
    ...
    def random_element(self, elements=('a', 'b', 'c')):
        ...
        """
        return self._random_elements(elements, length=1)[0]
    ...
    def random_sample(self, elements=('a', 'b', 'c'), length=None):
        ...
        """
        return self._random_elements(elements, length, unique=True)
